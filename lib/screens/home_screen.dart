    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          child: const Icon(Icons.sports_chess, color: AppTheme.accent, size: 20),
        ),
          ...
          child: Padding(
            ...
            child: Row(children: [
              ...
              Container(
                ...
                child: const Icon(Icons.sports_chess,
  ...
  Widget build(BuildContext context) {
    return ListView(padding: const EdgeInsets.all(16), children: [
      ...
      _SettingsSection(title: 'Editor', items: [
        ...
        _SettingItem(icon: Icons.magnet, label: 'Snap to Grid', value: 'On'),
